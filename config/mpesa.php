...
return [
    ...
    'dev_security_credential' => env('DEV_SECURITY_CREDENTIAL', 'YOUR_DEV_SECURITY_CREDENTIAL'),
    'production' => [
    ...
    'prod_security_credential' => env('PROD_SECURITY_CREDENTIAL', 'YOUR_PROD_SECURITY_CREDENTIAL'),
];